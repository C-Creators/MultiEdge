export const translations = {
  en: {
    ...
    register: {
      ...
      step2BtnDooprime: "Connect with Doo Prime",
      step2BtnCgtrade: "Connect with CGTrade",
      required: "Required",
      then: "then",
    ...
    calculator: {
      ...
      description: "Our bot generates 3-10% monthly returns. Enter your investment to see potential results.",
      ...
      perMonth: "/month",
      disclaimer: "These are projections based on historical performance. Actual results may vary. Past performance does not guarantee future results.",
    },
  },
  ...
  es: {
    ...
    register: {
      ...
      step2BtnDooprime: "Conectar con Doo Prime",
      step2BtnCgtrade: "Conectar con CGTrade",
      required: "Requerido",
      then: "luego",
    ...
    calculator: {
      ...
      title: "Estima Tus Ganancias",
      description: "Nuestro bot genera 3-10% de retorno mensual. Ingresa tu inversión para ver resultados potenciales.",
      ...
      perMonth: "/mes",
      disclaimer: "Estas son proyecciones basadas en rendimiento histórico. Los resultados reales pueden variar. El rendimiento pasado no garantiza resultados futuros.",
    },
  },
};
