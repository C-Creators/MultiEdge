export const translations = {
  en: {
    ...
    calculator: {
      ...
      description: "Uses verified bot data to project implied weekly, monthly, and yearly returns. Adjust the period and investment amount to see projections.",
      botGain: "Bot:",
      maxDD: "Max DD:",
      platform: "Platform:",
      leverage: "Leverage:",
      ...
      months: "mo",
      periodHelper: "Default is 6 months. Adjust based on actual bot performance duration for accurate projections.",
      weeklyROI: "Implied Weekly ROI",
      monthlyROI: "Implied Monthly ROI",
      yearlyROI: "Implied Yearly ROI (CAGR)",
      fullPeriod: "Bot result over full period",
      maxDrawdown: "Max drawdown (from peak)",
      save: "Save inputs",
      reset: "Reset",
      disclaimer: "These are projections derived from bot performance data. Real results can differ due to fees, slippage, spreads, copy delays, and changing market conditions. Past performance is not a guarantee.",
      howItWorks: "How the math works",
      mathExplanation: "We treat the bot gain (+264.40%) as the total growth factor over the selected period. From that we derive:",
  ...
  es: {
    ...
    calculator: {
      ...
      title: "Calculadora de ROI del Bot",
      description: "Utiliza datos verificados del bot para proyectar retornos implícitos semanales, mensuales y anuales. Ajusta el período y el monto de inversión para ver las proyecciones.",
      botGain: "Bot:",
      maxDD: "DD Máx:",
      platform: "Plataforma:",
      ...
      currency: "Moneda",
      periodLabel: "Período (meses)",
      months: "mes",
      periodHelper: "Por defecto 6 meses. Ajusta según la duración real del rendimiento del bot para proyecciones precisas.",
      weeklyROI: "ROI Semanal Implícito",
      monthlyROI: "ROI Mensual Implícito",
      yearlyROI: "ROI Anual Implícito (CAGR)",
      fullPeriod: "Resultado del bot en período completo",
      maxDrawdown: "Drawdown máximo (desde pico)",
      save: "Guardar",
      reset: "Reiniciar",
      disclaimer: "Estas son proyecciones derivadas del rendimiento del bot. Los resultados reales pueden diferir debido a comisiones, deslizamiento, spreads, retrasos de copia y condiciones cambiantes del mercado. El rendimiento pasado no es garantía.",
      howItWorks: "Cómo funciona el cálculo",
      mathExplanation: "Tratamos la ganancia del bot (+264.40%) como el factor de crecimiento total sobre el período seleccionado. De ahí derivamos:",
